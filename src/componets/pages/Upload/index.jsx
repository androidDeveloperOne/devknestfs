...
const Upload = ({
  ...
  const { uploadLoading, uploadFoldder } = useSelector(
    (state) => state?.uploadFolder
  );
  ...
  const createZip = async () => {
    ...
    //   } else {
    //     console.warn("folderContent prop is missing!");
    //   }
      ...
      if (folder.file && folder.file.length > 0) {
        ...
        for (const file of folder.file) {
          ...
          try {
            ...
            console.log("erroratfolderuplaod", error);
        ...
        for (const folderName of folder.folder) {
          ...
          try {
            ...
            console.log("existingFiles333", error);
          }
        }

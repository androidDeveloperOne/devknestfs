  ...
  async (loginData, { dispatch, getState, rejectWithValue }) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://dev.knestsensors.com:5000/api/Auth/Login`,
        body,
...
export const forgotPasswordAction = createAsyncThunk(
  ...
  async (emailData, {dispatch, getState, rejectWithValue}) => {
    try {
      ...
      const response = await axios.post(
        'https://dev.knestsensors.com:5000/api/Auth/ForgotPassword',
        body,
      );
  ...
  async (_, { dispatch, getState, rejectWithValue }) => {
    try {
      ...
      const { data } = await axios.post(
        `https://dev.knestsensors.com:5000/api/Auth/GenerateNewAccessToken`,
        reqdata,
        { timeout: 30000, timeoutErrorMessage: "Connection Timeout" }
      );
